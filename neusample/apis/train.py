...
import neusample
from neusample.core import DistEvalHook, EvalHook
from neusample.datasets import build_dataloader, build_dataset
...
def train_renderer(model,
    ...
    for param_adjust_hook in cfg.get('param_adjust_hooks', []):
        ...
        runner.register_hook(
            obj_from_dict(param_adjust_hook, neusample.core.hooks))
    runner.register_hook(neusample.core.hooks.IterAdjustHook(logger))
